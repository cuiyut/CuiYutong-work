    ...
    <div class="gong-wrapper">
        ...
        <el-breadcrumb separator="/">
           <el-breadcrumb-item :to="{ path: '/shou' }">首页</el-breadcrumb-item>
            <el-breadcrumb-item><a href="/gong">供应商管理</a></el-breadcrumb-item>
        </el-breadcrumb> 

        <!--表单  -->
        <el-form class="biaodan1"> 
            <el-input class="inp" v-model="querys.input" placeholder="供应商名称"></el-input>
            <el-input class="inp" v-model="querys.input1" placeholder="联系人"></el-input>
            <el-input class="inp" v-model="querys.input2" placeholder="联系电话"></el-input>
...
<script>
  export default {
    ...
    methods: {
        ...
        dogai() {
            this.$axios.put(`http://vue.mengxuegu.com/pro-api/supplier/${this.id}`).then(res => {
                this.$message({
                    type: 'success',
                    message: '修改成功'
                });
